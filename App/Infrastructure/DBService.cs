...
//        {
//            NpgsqlConnection connection = new NpgsqlConnection($"Host={dbHost};Port={dbPort};Username={dbUsername};Password={dbPassword};Database={dbDatabase}");
//            connection.Open();
...
//    {
//        // ATRIBUT kredensial db - tetap static readonly karena ini adalah konfigurasi
//        private static readonly string dbHost = "localhost";
//        private static readonly string dbDatabase = "PBO_BarberMate";
//        private static readonly string dbUsername = "postgres";
//        private static readonly string dbPassword = "dammahom51";
...
//        // METHOD untuk mendapatkan koneksi baru
