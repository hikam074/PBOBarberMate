    ...
    public partial class FormLihatPembayaranUntukUlasan : Form
    {
        ...
        public void LoadDataPembayaran()
        {
            try
            {
                ...
                //{
                //    DataTable dataPembayaran = PembayaranContext.getDataPembayaran(SessionService.idSession);
                ...
                dgvDataPembayaran.AllowUserToAddRows = false;
                    ...
                    //if (dgvDataPembayaran.Columns.Contains("id_akun") && SessionService.role == AkunRole.Customer)
                    //{
                    //    dgvDataPembayaran.Columns["id_akun"].Visible = false;
                    //}
                    //if (dgvDataPembayaran.Columns.Contains("nama_akun") && SessionService.role == AkunRole.Customer)
                    {
                ...
                //if (dgvDataPembayaran.Columns.Contains("Ulas") && SessionService.role != AkunRole.Customer)
                //    {
                //        dgvDataPembayaran.Columns["Ulas"].Visible = false;
                //    }
                //if (dgvDataPembayaran.Columns.Contains("Edit") && SessionService.role != AkunRole.Admin)
                //{
